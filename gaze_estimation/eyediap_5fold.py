...
if __name__ == "__main__":
  ...
  P_list={}
  P_list['0']=['p1.label','p2.label','p3.label']
  P_list['1']=['p4.label','p5.label','p6.label']
  P_list['2']=['p7.label','p8.label','p9.label']
  P_list['3']=['p10.label','p11.label','p14.label']
  P_list['4']=['p15.label','p16.label']
  ...
  for i in range(5):
    ...
    model_builder = msgazenet.build_WideResNet_dr(1, 16, 4, 0.01, 0.1, 0.5)
